...
#   Es
#   Es müssen keine weiteren Packet installiert werden, da alles schon mit python mit kommt
...
db = sqlite3.connect('Data/kopi.db')# Hier Brauchst du einen Order mit den namen "Data" damit die Datenbank weiß wo sie erstellt werden muss.
c = db.cursor()
c.execute('''
...
class Ticket(commands.Cog):
    ...
    async def guild(self, ctx):# hier kannst du dein guild eintragen ohne den send command zu Benutzen
        ...
        db.commit()
        await ctx.respond("Guild wurde eingetragen")
    ...
    async def send(self, ctx):# mit INSERT OR REPLACE wie der name schon sagt. Wird der gilt eingetragen oder ersetzt
        ...
        ticket_create.set_footer(text="Make by MK_Pascal#0505")
        ...
        erfolgreich.set_footer(text="Make by MK_Pascal#0505")
...
class TutorialView(discord.ui.View):
    ...
    async def button_callback1(self, button, interaction):
        ...
        if wert is None:
            ...
            if retry:
                liste = [f"Immer sachte mit den jungen Pferden! Warte mal noch  **{round(retry)}** sekunden",
                ...
                ticket_channel_em.set_footer(text="Make by MK_Pascal#0505")
...
class main(discord.ui.View):
    ...
    async def button_callback2(self, channel, interaction):
        ...
        if modrole in interaction.user.roles:
            ...
            close.set_footer(text="Make by MK_Pascal#0505")
            ...
            embed2.set_footer(text="Make by MK_Pascal#0505")
            ...
            teamrolle.set_footer(text="Make by MK_Pascal#0505")
    ...
    async def button_callback3(self, button, interaction):
        ...
        if modrole in interaction.user.roles:
            ...
            Bearbeiten.set_footer(text="Make by MK_Pascal#0505")
    ...
    async def button_callback4(self, button, interaction):
        ...
        infos.set_footer(text="Make by MK_Pascal#0505")
